...
# read in data sets to format
mix <- read.csv("ss_snook_mix.csv")
source <- read.csv("ss_snook_source.csv")
tdf <- read.csv("ss_snook_tdf.csv")

mix$fMonth<-as.factor(mix$Month)
mix$fYear<-as.factor(mix$Year)
mix<-na.omit(mix)
mix$ID <- seq_along(mix[,1])
str(mix)
write_csv(mix, "/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/mix_formatted.csv")

mix1 <- read.csv("mix_formatted.csv")
#### generate and run models

mix = load_mix_data(file("/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/mix_formatted.csv"),
...
# load source data
source = load_source_data(file("/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/ss_snook_source.csv"),
                          source_factors=NULL,
                          conc_dep=FALSE,
                          data_type="means",
                          mix)
# load TEF data
discr = load_discr_data(file("/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/ss_snook_tdf.csv"), mix)
...
output_sss = list(summary_save = TRUE,
                 summary_name = "/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/snook_ss",
                 sup_post = FALSE,
                 ...
                 geweke = TRUE,
                 diag_save = TRUE,
                 diag_name = "SPATIAL SIMILARITY PAPER/snook_diag",
                 indiv_effect = FALSE,
...
####
#### not getting what i think I need... try without id as factor
####

mix_1 = load_mix_data(file("/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/mix_formatted.csv"),
                    iso_names=c("d13C","d34S"),
                    factors= c("Year"),
                    fac_random=c(F),
                    fac_nested=c(F),
...
# load source data
source_1 = load_source_data(file("/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/ss_snook_source.csv"),
                          source_factors=NULL,
                          conc_dep=FALSE,
                          data_type="means",
                          mix_1)
# load TEF data
discr_1 = load_discr_data(file("/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/ss_snook_tdf.csv"), mix_1)

# Make an isospace plot
plot_data(filename="isospace_plot", plot_save_pdf=FALSE, plot_save_png=FALSE, mix_1,source_1,discr_1)

# Write the JAGS model file
model_filename = "MixSIAR_model.txt"
resid_err = T
process_err = T
write_JAGS_model(model_filename, resid_err, process_err, mix_1, source_1)

# run jags
jags.sss = run_model(run="test", mix_1, source_1, discr_1, model_filename,
                     alpha.prior = 1, resid_err, process_err)

# Process JAGS output
output_sss = list(summary_save = TRUE,
                  summary_name = "MixingModels/mm_results/sss_ss",
                  sup_post = FALSE,
                  plot_post_save_pdf = FALSE,
                  plot_post_name = "lower_posterior_density",
                  sup_pairs = FALSE,
                  ...
                  geweke = TRUE,
                  diag_save = TRUE,
                  diag_name = "MixingModels/mm_results/sss_diag",
                  indiv_effect = FALSE,
                  plot_post_save_png = F,
                  plot_pairs_save_png = FALSE,
                  plot_xy_save_png = FALSE)

output_JAGS(jags.sss, mix_1, source_1, output_sss)

####
#### TRY WITH PREY AGG BY FW VS ES VS SW
####

mix_2 = load_mix_data(file("/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/mix_formatted.csv"),
                      iso_names=c("d13C","d34S"),
                      factors= c("Year"),
                      fac_random=c(F),
                      fac_nested=c(F),
...
# load source data
source_2 = load_source_data(file("/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/ss_snook_source_agg.csv"),
                            source_factors=NULL,
                            conc_dep=FALSE,
                            data_type="means",
                            mix_2)
# load TEF data
discr_2 = load_discr_data(file("/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/snook_agg_nona.csv"), mix_2)

# agg <- read.csv("ss_snook_tdf_agg.csv") %>%
#      na.omit()
# glimpse(agg)
# write_csv(agg, "/Users/mack/Desktop/SPATIAL SIMILARITY PAPER/snook_agg_nona.csv")


# Make an isospace plot
plot_data(filename="isospace_plot", plot_save_pdf=FALSE, plot_save_png=FALSE, mix_2,source_2,discr_2)

# Write the JAGS model file
model_filename = "MixSIAR_model.txt"
resid_err = T
process_err = T
write_JAGS_model(model_filename, resid_err, process_err, mix_2, source_2)

# run jags
jags.sss = run_model(run="normal", mix_2, source_2, discr_2, model_filename,
                     alpha.prior = 1, resid_err, process_err)

# Process JAGS output
output_sss = list(summary_save = TRUE,
                  summary_name = "MixingModels/mm_results/snook_ss07192022",
                  sup_post = FALSE,
                  plot_post_save_pdf = FALSE,
                  plot_post_name = "lower_posterior_density",
                  sup_pairs = FALSE,
                  ...
                  geweke = TRUE,
                  diag_save = TRUE,
                  diag_name = "MixingModels/mm_results/snook_diag07192022",
                  indiv_effect = FALSE,
                  plot_post_save_png = F,
                  plot_pairs_save_png = FALSE,
                  plot_xy_save_png = FALSE)

output_JAGS(jags.sss, mix_2, source_2, output_sss)

# read in raw data for meeting with ryan
mix <- read.csv("mix_formatted.csv")
source <- read.csv("ss_snook_source_agg.csv")
tdf <- read.csv("snook_agg_nona.csv")
